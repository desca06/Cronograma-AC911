...
type CalendarioCemacoEditableProps = {
  mes: string;
  diasMes: number;
...
export function CalendarioCemacoEditable({
  mes,
  diasMes,
  notasIniciales,
  trabajos,
}: CalendarioCemacoEditableProps) {
  ...
  const guardar = () => {
    ...
    iniciarTransicion(async () => {
      try {
        ...
        const respuesta =
          await guardarNotaCemaco(formData);
        ...
        console.error(
          "Error al guardar la nota CEMACO:",
          error,
        );
  ...
  const eliminar = () => {
    ...
    iniciarTransicion(async () => {
      try {
        ...
        const respuesta =
          await eliminarNotaCemaco(formData);
        ...
        console.error(
          "Error al eliminar la nota CEMACO:",
          error,
        );
